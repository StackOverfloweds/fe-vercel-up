...
export default {
    ...
    computed: {
        totalAmount() {
            // Calculate the total amount (quantity * price) for the filtered transactions
        ...
        totalPrice() {
            // Calculate the total sum of all prices in the filtered transactions
            return this.filteredTransactions.reduce(
        ...
        filterTransactions() {
            ...
            this.filteredTransactions = this.searchDate
                ? this.transactions.filter(
                      (transaction) => transaction.date === this.searchDate
                  )
                : this.transactions;
        },
